    ...
    _createClass(HDWallet, {
        ...
        makeInvoiceList: {
            ...
            value: function makeInvoiceList(strAmount) {
                ...
                if (this.ver == HDWallet._version().mpriv.byte) path = "M/1/";else if (this.ver == HDWallet._version().mpub.byte) path = "M/";else throw new Error("Version of HDWallet mismatch");
